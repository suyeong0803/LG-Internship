...
//    AVFormatContext* m_oFcontext = NULL;
//    AVStream*        m_oVstream;
//
...
//
//
//	for (unsigned i = 0; i < m_iFcontext->nb_streams; i++)
//	{
//		if (m_iFcontext->streams[i]->codec->codec_type == AVMEDIA_TYPE_VIDEO)
//		{
...
//		
//		c->bit_rate = m_iVstream->codec->bit_rate;
...
//	}
//
//	avio_open(&m_oFcontext->pb, "output.mp4", AVIO_FLAG_WRITE);
...
//
//			printf("dts : %lld pts : %lld\n", m_iPkt.dts, m_iPkt.pts);
//
//			static int num = 1;
//			printf("frame : %d\n", num++);
//
//			ret = av_interleaved_write_frame(m_oFcontext, &m_iPkt);
//			if (ret < 0)
//			{
